        ...
        <div class="container">
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                                        include("../conexao.php");
                                        include("../calendario/conexaoCalendar.php");
                                        ...
                                        if($clube_mandante == $clube_visitante){?>
                                            <div class="alert alert-danger">
                                              ...
                                              if($cont > 0){?>
                                                    ...
                                                    //id partida
                                                    $ids = $db->query("SELECT * FROM partida ORDER BY id DESC LIMIT 1");
                                                    $proximoId = $ids->fetch_assoc();
                                                    $proximoId = $proximoId['id'];

                                                    $link = "../calendario/listar_partidas.php?data=".$data;

                                                    $csql ="INSERT INTO eventos (data, mandante,  visitante, link, id_partida) 
                                                           values ('$data','$clube_mandante',  '$clube_visitante', '$link', '$proximoId')";
                                                                $calendar = mysqli_query( $pdo, $csql);
